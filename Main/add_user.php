...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $conn->prepare("INSERT INTO users (firstname, middlename, lastname, username, password, avatar, type) VALUES (?, ?, ?, ?, ?, ?, ?)");
    $stmt->bind_param("ssssssi", $firstname, $middlename, $lastname, $username, $password, $avatar, $type);
...
<body>
    ...
    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
        ...
        <input type="number" id="type" name="type" min="0" max="1" required><br>
